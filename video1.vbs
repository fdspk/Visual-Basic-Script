...
'MsgBox "Hello", "36", "teste"
mensagem=msgbox ("Is it your bithday?","20","Hello")
if (mensagem=6) then msgbox "Happy Birthday!", 64 '6=yes, 7 =no

If (mensagem=7) then MsgBox"Oops", 16
